...
//	Item POOLFISH_SPAWN_EGG = createItem("poolfish_spawn_egg", new SpawnEggItem(ModEntities.POOLFISH, 0xF1FBFF, 0xCEDCFF, new Item.Settings().group(ASTRONOMICAL_ITEM_GROUP)));
