...
public interface ModItems {
	...
	Item MARSHMALLOW_STICK = createItem("marshmallow_stick", new MarshmallowStickItem(new QuiltItemSettings().maxCount(1).maxDamage(4).group(ASTRONOMICAL_ITEM_GROUP)));
